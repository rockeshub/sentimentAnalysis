...
var AppComponent = /** @class */ (function () {
    function AppComponent(http) {
        ...
        this.tiles = { text: 'One', cols: 1, rows: 2, color: 'white' };
        this.mtiles = { text: 'One', cols: 2, rows: 2, color: 'white' };
    }
    AppComponent.prototype.analyse = function (text) {
        var _this = this;
        var payload = {
            'text': text
        };
        console.log('text', text);
        this.http.addHero(payload).subscribe(function (res) {
            console.log('res', res);
            _this.result = res;
            _this.resultEmoji = lodash__WEBPACK_IMPORTED_MODULE_2__["find"](_this.emoji, { 'score': lodash__WEBPACK_IMPORTED_MODULE_2__["round"](res.score) });
        }, function (error) {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            imports: [
                ...
                _mat_module__WEBPACK_IMPORTED_MODULE_5__["AllMaterialModule"],
                _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"],
                _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"],
                _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientXsrfModule"]
            ],
            providers: [_http_error_handler_service__WEBPACK_IMPORTED_MODULE_7__["HttpErrorHandler"],
...
var HttpService = /** @class */ (function () {
    function HttpService(http, httpErrorHandler) {
        this.http = http;
        this.heroesUrl = 'http://localhost:8000/sentiment'; // URL to web api
    ...
    HttpService.prototype.addHero = function (hero) {
...
module.exports = __webpack_require__(/*! /home/mean/Documents/sentimentAnalysis/src/main.ts */"./src/main.ts");
